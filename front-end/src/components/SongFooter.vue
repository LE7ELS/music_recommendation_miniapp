<template>
	<View class="SongFooter" :style="song && song.id ? 'display: block' : 'display: none'">
		<View class="box">
			<Image @click="go" :class="['avatar', audio_paused ? 'paused' : '']" :src="
                    song.al.picUrl
			...
			<Image class="list" @click="show = true" :src="require('../static/play_icn_src_footer.png')" />
		</View>
		<View class="Stance" />
